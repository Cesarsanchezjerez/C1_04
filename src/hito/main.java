...
public class main {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		Estado estado= new Estado(2,2,3,5,6,5);
		estado.inicializarTerreno();
		Accion accion=new Accion(null,desde,null);
		
		Nodo nodo= new Nodo(null,estado,0,accion,0);
		
		sucesores=nodo.sucesores();
		
		for (Nodo n : sucesores) {
			System.out.println(n.getAccion().toString());
		}
